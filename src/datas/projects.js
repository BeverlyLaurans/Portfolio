export const projectsDatas = [
	...
	},
	{
		...
		"tasks": [
			...
			"Gestion de la suppression et de l'ajout d'un projet de manière dynamique"
		]
	},
	{
		"id": "9738591",
		...
		"description": "Booki est un site permettant de trouver des hébergements et des activités en fonction de la ville recherchée.",
		"goals": [
			"Intégrer l'interface en HTML / CSS",
		...
		"tasks": [
			"Découpage de la maquette pour préparer l'intégration",
			"Utilisation de Flexbox et de Grid Layout pour la mise en page",
			"Utilisation des media queries pour le responsive design",
			"Vérification et validation du code avec les validatateurs du W3C"
		]
	}
]