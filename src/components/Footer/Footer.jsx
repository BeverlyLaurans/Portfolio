    ...
    <footer>
      ...
      <div className={`footer-links ${theme}`}>
        ...
        <div className="footer-links__social">
          <a href="https://github.com/BeverlyLaurans">
            <img
              src={theme === "dark" ? whiteGithubIcon : githubIcon}
              alt="Icône GitHub"
            ></img>
          </a>
          <a href="https://fr.linkedin.com/in/beverlylaurans">
            <img
              src={theme === "dark" ? whiteLinkedinIcon : linkedinIcon}
              alt="Icône LinkedIn"
            ></img>
          </a>
        </div>
        ...
        <Modal
          ...
          modalDetails={
            <p>
              ...
              <br />
              <br />
              Ce site n'utilise pas de cookies et ne collecte aucune donnée à
              caractère personnel.
            </p>
          }
