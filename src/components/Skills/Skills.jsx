  ...
  return (
    <section className="skills" id="competences">
      <div className="skills__heading">
        ...
        <p>
          Mon profil s'axe autour du webmarketing et du développement web. Je
          vous propose de faire un tour d'horizon sur mes principales
          compétences, et celles que je prévois d'acquérir prochainement !
        </p>
      </div>
      <Accordion
        ...
        accordionDetails={
          <div className="skills__list">
            <div className="skills__list-category">
              ...
              <ul>
                {skillsDatas[0]["languages-&-technologies"].map(
                  (technology) => (
